...
const Home = () => {
  ...
  const filtered = selectedCategory === "All Events" ? events :
    events.filter(
      event => {
...

      {
        ...
        loading
          ...
          <FeaturedExperience
            ...
            event={{
              ...featuredEvent, image: featuredEvent.images?.[0], venueAddress: featuredEvent.location ? `${featuredEvent.location.address},
